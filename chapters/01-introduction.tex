...
sicurezza, in modo continuo e su larga scala. 
Moon Cloud supporta una semplice ed efficente \textit{ICT Security Governance}, dove le politiche di sicurezza 
...
\end{description}
\ \\
Moon Cloud è un framework di \textit{Security Assurance} il quale garantisce che tutte le attività aziendali si compiano seguendo i requisiti 
...
attraverso una serie di controlli che a seconda delle caratteristiche e proprietà del target, potrà avere successo o meno. Di 
