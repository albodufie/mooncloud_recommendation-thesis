...
\begin{lstlisting}[language=Python, label=lst:model, caption={Parti principali del codice che costituisce i Model della soluzione.}]
# TARGET TYPE MODEL
...
\begin{description}
    ...
    rappresentante l'URL dell'applicativo web, \textit{Host}, viene specificato l'indirizzo Ip identificativo di un host e si distingue tra sistema operativo \textit{Windows} o \textit{Linux} eseguito su esso, \textit{Aws}, rappresentante il servizio di cloud computing del 
