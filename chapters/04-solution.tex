...
in cui ogni test richiama la funzione da testare, salva il suo risultato, e lo confronta con il risultato atteso, 
oltre a verificare che il codice della risposta HTTP corrisponda al codice atteso.\hfill\break
