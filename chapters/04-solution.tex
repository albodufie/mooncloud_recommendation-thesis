...
% questi algoritmi, e nel caso dello User e Item algortihm, mostrare le view che li implementano come API REST 
...
%% SOSTITUIRE QUESTO CODICE CON UN ELENCO CHE DESCRIVE LE API REST
\begin{description}
    ...
    \begin{itemize}
        \item Descrizione: ritorna tutte le possibili Evaluation, usate da altri utenti, simili a quelle usate da un certo Utente.
        \item Input: si trovano i seguenti parametri:
        \begin{itemize}
            \item oggetto contenente la HTTP Request
