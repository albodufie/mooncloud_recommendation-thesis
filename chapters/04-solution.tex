...
%
\begin{figure}[ht!]
    \includegraphics[scale=0.48]{images/MCRS_taxindex.jpg}
...
\begin{itemize}
    ...
    \begin{figure}[ht!]
        \centering
        \includegraphics[scale=0.44]{images/MCRS_taxnodedetails.jpg}
    ...
    \begin{figure}[ht!]
        \centering
        \includegraphics[scale=0.45]{images/MCRS_taxdetails.jpg}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[scale=0.4]{images/MCRS_adminpage.jpg}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[scale=0.4]{images/MCRS_adminpage_evaluationEX.jpg}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[scale=0.6]{images/MCRS_adminpage_evaluationEX_add.jpg}
