...
momento in cui viene fatta una richiesta HTTP a questo URL \texttt{recommendation/item/<str:item\_other\_id>/} viene richiamata la 
View \texttt{recommendation\_views.item\_recommendation} passando il parametro \texttt{<str:item\_other\_id>}.
\lstset{style=python_code_style}
...
nel database per il valore del parametro \texttt{<str:item\_other\_id>} in ingresso, verificando l'esistenza di quell'item, questo è possibile
