...
o parole chiave, si usa l'indentazione stessa per indicare i blocchi nidificati in congiunzione col carattere "due punti" (\textbf{\:}). Si usa 
...
sempre meno performante.\hfill\break
...
i Controlli (politiche per verificare il soddisfacimento dei requisiti di sicurezza di un Target o asset indicato dall'utente) all'interno del progetto.\hfill\break
Questo approccio permette di osservare le gerarchie di dati in un modo diverso, non come nodi e linee di una struttura ad albero, ma come container innestati.
%
\begin{figure}[ht!]
