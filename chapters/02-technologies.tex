...
vengono sfruttate tecniche di analisi dei dati per poter ottenere delle raccomandazioni che consiglino gli utenti a trovare gli item 
...
\begin{description}
    \item Il \textbf{primo obbiettivo} è quello di migliorare la scalabilità di questi algoritmi; essi sono in grado di cercare 
    ...
    molte informazioni associate.
    \item Il \textbf{secondo obbiettivo} è quello di migliorare la qualità dei sistemi di raccomandazione per gli utenti. Questi ultimi vogliono 
...
\begin{description}
    ...
    il valore di questo item all'interno dell'ecosistema; quindi maggiore è l'interazione che un item riceve, e più è facile che venga raccomandato 
