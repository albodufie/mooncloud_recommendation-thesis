...
\texttt{user\_other\_id}, come è possibile osservare dal Codice \ref{lst:UB_CF_1}, corrispondente all'identificativo dell'utente, 
...
\begin{itemize}
    ...
    eliminati eventuali duplicati; e la funzione ritorna una lista \texttt{similar\_item\_evaluations} contente le Evaluation simili.
...
(attraverso un particolare URL) e lo \texttt{user\_other\_id}, un valore recuperato come parametro dall'URL e rappresenta 
